...
class SysMenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'menuorder' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-05-31 23:01:32',
            'modified' => '2018-05-31 23:01:32'
        ],
    ];
}
