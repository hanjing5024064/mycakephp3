    ...
    <tr>
        ...
        <td>
            <div class="input text required">
                <input type="text" name='<?= $this->request->param('controller') . '[' . $eachFields . ']' ?>' class="form-control">
            </div>
        </td>
        <?php endif; ?>
            ...
            <td colspan="3">
                <div class="input text select-time form-small40 display-inline">
                    <input type="text" name="<?= $this->request->param('controller') . '[' . $eachFields . '][from]' ?>"
                           class="form-control datepicker"/><span class="input-time"><span class="glyphicon glyphicon-calendar"></span></span></div>
                <div class="display-inline">-</div>
                <div class="input text select-time form-small40 display-inline">
                    <input type="text" name="<?= $this->request->param('controller') . '[' . $eachFields . '][to]' ?>"
                           class="form-control datepicker"/>
                    <span class="input-time"><span class="glyphicon glyphicon-calendar"></span></span></div>
            </td>
            </div>
        <?php endif; ?>
